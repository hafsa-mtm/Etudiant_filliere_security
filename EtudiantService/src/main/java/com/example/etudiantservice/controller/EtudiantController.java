...
public class EtudiantController {
    ...
    @PostMapping
    @PreAuthorize("hasAuthority('SCOPE_ADMIN')")  // Only ADMIN can create
    ...
    @GetMapping
    @PreAuthorize("hasAnyAuthority('SCOPE_USER', 'SCOPE_ADMIN')")  // Both USER and ADMIN can read all
    ...
    @GetMapping("/{id}")
    @PreAuthorize("hasAnyAuthority('SCOPE_USER', 'SCOPE_ADMIN')")  // Both USER and ADMIN can read by ID
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasAuthority('SCOPE_ADMIN')")  // Only ADMIN can update
